...
declare global {
  ...
  interface HTMLElementEventMap {
    ...
    'item-add-child': CustomEvent<{ type: 'STORY' | 'TASK'; parentId: string; parentName: string; parentShortId: string | null; parentUrl: string | null; parentType: string | null; project: string | null }>;
